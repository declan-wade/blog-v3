...
export default function Footer() {
  return (
    <footer className="fixed inset-x-0 flex my-1 gap-5 p-3 pl-5 pe-5 rounded-full place-self-center items-center justify-center outline outline-1 outline-white bottom-5 backdrop-blur-md">
      <a
